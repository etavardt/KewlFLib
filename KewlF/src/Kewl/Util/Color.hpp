...
namespace Kewl
{
    ...
    struct Color
    {
        ...
        Color() {}
        Color(ColorComponentType _r, ColorComponentType _g, ColorComponentType _b, ColorComponentType _a) : r(_r), g(_g), b(_b), a(_a) {}
        Color(const glm::vec4& _c) : r(_c.r), g(_c.g), b(_c.b), a(_c.a) {}
